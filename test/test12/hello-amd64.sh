...
hex2 -f test/common_amd64/ELF-amd64.hex2 -f test/test12/break-for.hex2 --LittleEndian --architecture amd64 --BaseAddress 0x00600000 -o test/results/test12-amd64-binary --exec_enable || exit 3
...
then
	...
	./test/results/test12-amd64-binary >| test/test12/proof || exit 4
