...
hex2 -f test/common_armv7l/ELF-armv7l.hex2 -f test/test12/break-for.hex2 --LittleEndian --architecture armv7l --BaseAddress 0x10000 -o test/results/test12-armv7l-binary --exec_enable || exit 3
