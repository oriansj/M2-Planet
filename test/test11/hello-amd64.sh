...
hex2 -f test/common_amd64/ELF-amd64.hex2 -f test/test11/break-do.hex2 --LittleEndian --architecture amd64 --BaseAddress 0x00600000 -o test/results/test11-amd64-binary --exec_enable || exit 3
...
then
	...
	./test/results/test11-amd64-binary >| test/test11/proof || exit 4
