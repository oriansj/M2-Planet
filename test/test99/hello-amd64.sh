...
hex2 -f test/common_amd64/ELF-amd64.hex2 -f test/test99/cc0.hex2 --LittleEndian --architecture amd64 --BaseAddress 0x00600000 -o test/results/test99-amd64-binary --exec_enable || exit 3
...
then
	...
	./test/results/test99-amd64-binary < test/test99/cc500.c >| test/test99/cc1 || exit 4
