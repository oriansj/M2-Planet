...
hex2 -f test/common_amd64/ELF-amd64.hex2 -f test/test0018/math.hex2 --LittleEndian --architecture amd64 --BaseAddress 0x00600000 -o test/results/test0018-amd64-binary --exec_enable || exit 3
