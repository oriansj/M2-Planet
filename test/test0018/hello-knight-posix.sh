...
hex2 -f test/common_knight/ELF-knight.hex2 -f test/test0018/math.hex2 --BigEndian --architecture knight-posix --BaseAddress 0x00 -o test/results/test0018-knight-posix-binary --exec_enable || exit 3
...
then
	...
	./test/results/test0018-knight-posix-binary >| test/test0018/proof || exit 4
