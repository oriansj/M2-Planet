...
hex2 -f test/common_x86/ELF-i386.hex2 -f test/test0020/struct.hex2 --LittleEndian --architecture x86 --BaseAddress 0x8048000 -o test/results/test0020-x86-binary --exec_enable || exit 3
