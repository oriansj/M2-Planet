...
hex2 -f test/common_x86/ELF-i386.hex2 -f test/test0106/cc0.hex2 --LittleEndian --architecture x86 --BaseAddress 0x8048000 -o test/results/test0106-x86-binary --exec_enable || exit 3
