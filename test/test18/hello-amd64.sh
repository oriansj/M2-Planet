...
hex2 -f test/common_amd64/ELF-amd64.hex2 -f test/test18/math.hex2 --LittleEndian --architecture amd64 --BaseAddress 0x00600000 -o test/results/test18-amd64-binary --exec_enable || exit 3
...
then
	...
	./test/results/test18-amd64-binary >| test/test18/proof || exit 4
