...
hex2 -f test/common_amd64/ELF-amd64.hex2 -f test/test19/getopt.hex2 --LittleEndian --architecture amd64 --BaseAddress 0x00600000 -o test/results/test19-amd64-binary --exec_enable || exit 3
...
then
	...
	./test/results/test19-amd64-binary -f test/test19/input -o test/test19/proof || exit 4
