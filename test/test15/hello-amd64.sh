...
hex2 -f test/common_amd64/ELF-amd64.hex2 -f test/test15/file_read.hex2 --LittleEndian --architecture amd64 --BaseAddress 0x00600000 -o test/results/test15-amd64-binary --exec_enable || exit 3
...
then
	...
	./test/results/test15-amd64-binary test/test15/file_read.c >| test/test15/proof || exit 4
