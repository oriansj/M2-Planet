...
hex2 -f test/test0017/memset.hex2 --BigEndian --architecture knight-native --BaseAddress 0x00 -o test/results/test0017-knight-native-binary --exec_enable || exit 3
...
then
	...
	./test/results/test0017-knight-native-binary >| test/test0017/proof || exit 4
