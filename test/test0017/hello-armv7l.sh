...
set -ex
# Build the test
bin/M2-Planet --architecture armv7l -f test/common_armv7l/functions/malloc.c \
...
hex2 -f test/common_armv7l/ELF-armv7l.hex2 -f test/test0017/memset.hex2 --LittleEndian --architecture armv7l --BaseAddress 0x10000 -o test/results/test0017-armv7l-binary --exec_enable || exit 3
